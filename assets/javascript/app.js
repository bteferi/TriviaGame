...
function start_Game() {
  ...
  // add in this for
  // $(".start_Game").html("")
  var Counter_Id = setInterval(countdown, 1000);
...
function Submit_Button() {
  ...
  //below we are updating our HTML PAGE with the variabes because the subbmit button is working

  $(".start_Game").html("<p>Correct Answers:</p>" + correct_a + "<p> Incorrect Answer: </p>" + incorrect_answers + "<p> unanswered </p>" + unanswered);
    is_SubmitButton_clicked=true;
};
